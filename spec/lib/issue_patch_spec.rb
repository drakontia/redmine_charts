  ...
  module IssuePatch
    describe 'IssuePatch' do
      ...
      it 'should add issue_status' do
        ...
        expect(issue_status[0].day).to eq(2_010_070)
        expect(issue_status[0].week).to eq(2_010_010)
        expect(issue_status[0].month).to eq(2_010_003)
        expect(issue_status[0].issue_id).to eq(@issue.id)
        expect(issue_status[0].project_id).to eq(15_041)
      ...
      it 'should add done_ratio' do
        ...
        expect(done_ratio[0].project_id).to eq(15_041)
        expect(done_ratio[0].done_ratio).to eq(10)

        expect(done_ratio[1].day).to eq(2_010_070)
        expect(done_ratio[1].week).to eq(2_010_010)
        expect(done_ratio[1].month).to eq(2_010_003)
        expect(done_ratio[1].issue_id).to eq(@issue.id)
        expect(done_ratio[1].project_id).to eq(15_041)
