  ...
  module TimeEntryPatch
    describe 'TimeEntryPatch' do
      ...
      it 'should add charts time entry' do
        ...
        expect(time_entries[0].day).to eq(2_010_070)
        expect(time_entries[0].week).to eq(2_010_010)
        expect(time_entries[0].month).to eq(2_010_003)
        expect(time_entries[0].issue_id).to eq(@issue.id)
        expect(time_entries[0].project_id).to eq(15_041)
        ...
        expect(time_entries[1].project_id).to eq(15_041)
        ...
        expect(time_entries[2].day).to eq(2_010_071)
        ...
        expect(time_entries[3].day).to eq(2_010_071)
