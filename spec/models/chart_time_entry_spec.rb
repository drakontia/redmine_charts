...
describe ChartTimeEntry do
  ...
  it "should aggregation_for_issue_grouping" do
    ...
    expect(aggregation[0].group_id).to eq(15044)
    expect(aggregation[1].group_id).to eq(15045)
    expect(aggregation[2].group_id).to eq(15043)
    expect(aggregation[3].group_id).to eq(15041)
  ...
  it "should aggregation_for_category_grouping" do
    ...
    expect(aggregation[0].group_id).to eq(15042)
    expect(aggregation[1].group_id).to eq(15041)
  ...
  it "should timeline" do
    ...
    expect(timeline[0].range_value).to eq(2010004)
    expect(timeline[3].range_value).to eq(2010010)
  ...
  it "should timeline_weeks_full_range" do
    ...
    expect(timeline[0].logged_hours).to be_within(1).of(4.55)
    expect(timeline[0].entries).to eq(1)
    expect(timeline[1].range_value).to eq(2010005)
    expect(timeline[1].logged_hours).to be_within(1).of(1.3)
    expect(timeline[1].entries).to eq(1)
    expect(timeline[2].range_value).to eq(2010009)
  ...
  it "should timeline_months_full_range" do
    ...
    expect(timeline[0].range_value).to eq(2010001)
    expect(timeline[0].logged_hours).to be_within(1).of(4.55)
    expect(timeline[0].entries).to eq(1)
    expect(timeline[1].range_value).to eq(2010002)
    expect(timeline[1].logged_hours).to be_within(1).of(1.3)
    expect(timeline[1].entries).to eq(1)
    expect(timeline[2].range_value).to eq(2010003)
  ...
  it "should timeline_days_restricted" do
    ...
    expect(timeline[0].range_type).to eq('days')
    expect(timeline[0].range_value).to eq(2010062)
    expect(timeline[4].range_value).to eq(2010069)
    expect(timeline[0].group_id.to_i).to eq(0)
    expect(timeline[0].grouping).to eq('')
  end
  ...
  it "should timeline_weeks_restricted" do
    ...
    expect(timeline[0].range_type).to eq('weeks')
    expect(timeline[0].range_value).to eq(2010005)
    expect(timeline[1].range_value).to eq(2010009)
    expect(timeline[0].group_id.to_i).to eq(0)
    expect(timeline[0].grouping).to eq('')
  end
  ...
  it "should timeline_months_restricted" do
    ...
    expect(timeline[0].range_type).to eq('months')
    expect(timeline[0].range_value).to eq(2010002)
    expect(timeline[0].group_id.to_i).to eq(0)
    expect(timeline[0].grouping).to eq('')
  end
  ...
  it "should timeline_groping_users" do
    ...
    expect(timeline[3].range_value).to eq(2010003)
    ...
    expect(timeline[4].range_value).to eq(2010003)
  ...
  it "should timeline_groping_and_conditions" do
    ...
    expect(timeline[0].range_value).to eq(2010009)
    ...
    expect(timeline[1].range_value).to eq(2010010)
  ...
  it "should aggregation_for_issue" do
    ...
    expect(aggregation[15043]).to be_within(1).of(7.6)
    expect(aggregation[15044]).to be_within(1).of(8.9)
    expect(aggregation[15045]).to be_within(1).of(8.9)
    expect(aggregation[15041]).to be_within(1).of(5.5)
  end
