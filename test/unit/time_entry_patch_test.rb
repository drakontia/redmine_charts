...
class TimeEntryPatchTest < ActiveSupport::TestCase
  def test_time_entry
    ...
    assert_equal 2_010_070, time_entries[0].day
    assert_equal 2_010_010, time_entries[0].week
    assert_equal 2_010_003, time_entries[0].month
    assert_equal issue.id, time_entries[0].issue_id
    assert_equal 15_041, time_entries[0].project_id
    ...
    assert_equal 15_041, time_entries[1].project_id
    ...
    assert_equal 2_010_071, time_entries[2].day
    ...
    assert_equal 2_010_071, time_entries[3].day
