  ...
  module TimeEntryPatch
    ...
    module InstanceMethods
      def chart_remove_time_entry
        ...
        day = RedmineCharts::RangeUtils.format_day(spent_on)
        week = RedmineCharts::RangeUtils.format_week(spent_on)
        month = RedmineCharts::RangeUtils.format_month(spent_on)
      ...
      def chart_update_time_entry
        RedmineCharts::TimeEntryPatch.remove_chart_time_entry(project_id_was, issue_id_was, user_id_was, activity_id_was, hours_was, spent_on_was)
        RedmineCharts::TimeEntryPatch.add_chart_time_entry(project_id, issue_id, user_id, activity_id, hours, spent_on)
      end
    end
  end
end
